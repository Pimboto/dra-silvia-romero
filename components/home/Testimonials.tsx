...
const testimonials: Testimonial[] = [
  ...
  },
  {
    ...
    text_es:
      "No puedo recomendar lo suficiente a esta excepcional cirujana plástica, la Dra. Silvia Romero, y a su destacado equipo. Con una habilidad incomparable y un enfoque compasivo centrado en el paciente, brindan un nivel extraordinario de atención. Estoy muy satisfecho con los resultados de mi doble blefaroplastia y lifting facial. La experiencia de la Dra. Romero es evidente en cada detalle.",
    avatar: "HG",
  },
  {
    id: 3,
    ...
    rating: 5,
    text_en:
      "The best of the best in plastic surgery, Dr. SILVIA ROMERO is excellent at her work. I had surgery with her and I am super happy and grateful, because I feel beautiful and my self-esteem has risen to the maximum with this great change. Her team is phenomenal, the facilities are beautiful and very comfortable.",
    text_es:
  ...
  },
  {
    ...
    rating: 5,
    text_en:
      "The best plastic surgery clinic. Dr. Silvia Romero is the best plastic surgeon I know. My surgery was exceptional and the team and facilities are unique. HIGHLY RECOMMENDED!!",
    text_es:
      "La mejor clínica de cirugía plástica, La Dra Silvia Romero es la mejor cirujana plástica que conozco, mi cirugía fue excepcional y el equipo de trabajo y las instalaciones son únicos. SÚPER RECOMENDADOS!!",
    avatar: "RN",
  },
  {
    id: 5,
    ...
    rating: 5,
    text_en:
      "I want to express my deepest gratitude to Dr. Silvia Romero and her wonderful team in Medellín, Colombia for the extraordinary surgery they performed on me. The human quality and professionalism they demonstrated have made this experience unforgettable. They not only provided me with impeccable surgery, but managed to combine health and beauty perfectly.",
    text_es:
      "Quiero expresar mi más profundo agradecimiento a la doctora Silvia Romero y a su maravilloso equipo en Medellín, Colombia por la extraordinaria cirugía que me realizaron. La calidad humana y profesionalismo que demostraron han hecho de esta experiencia algo inolvidable. No solo me brindaron una cirugía impecable, sino que lograron combinar salud y belleza de manera perfecta.",
    avatar: "MB",
  },
  {
    id: 6,
    ...
    rating: 5,
    text_en:
      "A WONDERFUL EXPERIENCE!!! Dr. Silvia Romero is an excellent professional! A beautiful work team full of professionalism and human quality!! HIGHLY RECOMMENDED!",
    text_es:
      "Una EXPERIENCIA MARAVILLOSA !!! La Dra Silvia Romero excelente profesional ! Un equipo de trabajo precioso lleno de profesionalismo y calidad humana !! SUPER RECOMENDADO !",
    avatar: "AS",
  },
  {
    id: 7,
    ...
    text_es:
      "Excelente servicio, personal increíble, ¡Dra. Silvia Romero excepcional!",
    avatar: "RD",
  },
  {
    id: 8,
  ...
  },
  {
    ...
    rating: 5,
    text_en:
      "I want to deeply thank Dr. Silvia Romero for her excellent care. Her professionalism, dedication and warmth made me feel very well cared for and safe throughout the entire process. Highly recommended!",
    text_es:
      "Quiero agradecer profundamente a la Dra. Silvia Romero por su excelente atención. Su profesionalismo, dedicación y calidez hicieron que me sintiera muy bien atendida y segura durante todo el proceso. ¡Altamente recomendado!",
    avatar: "CP",
  },
  {
    id: 13,
    ...
    text_es:
      "Recientemente tuve el placer de someterme a una cirugía con la Dra. Silvia, ¡y no puedo recomendarla lo suficiente! Desde la consulta inicial hasta mi cuidado postoperatorio, la experiencia fue excepcional. La Dra. Silvia fue increíble. Se tomó el tiempo para responder todas mis preguntas y me hizo sentir completamente cómoda durante todo el proceso. Su experiencia y compasión realmente se destacaron.",
    avatar: "JF",
  },
  {
    id: 14,
  ...
  },
  {
    ...
    rating: 5,
    text_en:
      "Dr. Silvia is a great person and excellent professional and her team is very friendly. The best care and excellent service.",
    text_es:
      "La Dra. Silvia es una gran persona y excelente profesional, y su equipo es muy amable. La mejor atención y excelente servicio.",
    avatar: "MM",
  },
  {
    id: 16,
    ...
    rating: 5,
    text_en:
      "Excellent attention, Dr. Silvia is the best, a great human being.",
    text_es:
      "Excelente atención, la doctora Silvia es la mejor, un gran ser humano",
    avatar: "AC",
  },
  {
    id: 17,
    ...
    rating: 5,
    text_en:
      "Great experience from the consultation, surgery, aftercare. Dr. Romero and the entire staff helped each step along the way.",
    text_es:
      "Gran experiencia desde la consulta, la cirugía y el cuidado posterior. La Dra. Romero y todo el personal ayudaron en cada paso del camino.",
    avatar: "CS",
  },
  {
    id: 18,
    ...
    rating: 5,
    text_en:
      "The best decision I could have made. Dr. Silvia is a great, great surgeon.. I am very happy with the change she made in me.. and her staff is first class.. thank you Doctor!",
    text_es:
      "La mejor decisión que pude tomar, La Doctora Silvia es una gran gran cirujana.. estoy muy contento del cambio que hizo en mí.. y su staff de primera.. gracias Doctora!",
    avatar: "MV",
  },
  {
    id: 19,
    ...
    rating: 5,
    text_en:
      "I recently had a procedure with Dr. Silvia and I am very grateful to her as she understood what I wanted. She is a person with incredible energy. A mention to the team as I felt very accompanied and at ease being in their hands. Overall I felt very well.",
    text_es:
      "Hace poco me hice un procedimiento con la Dra. Silvia y estoy muy agradecida con ella ya que comprendió lo que yo quería, ella es una persona con una energía increíble. Una mención al equipo ya que me sentí muy acompañada y tranquila de estar en sus manos. En general me sentí muy bien.",
    avatar: "MA",
  },
  {
    id: 20,
    ...
    text_es:
      "Se caracterizan por su profesionalismo, amabilidad y atención al detalle. Se preocuparon no solamente por mi cirugía sino por mi bienestar, por resolver nuestras inquietudes a tiempo. Desde la Doctora Silvia hasta todas las chicas que conforman el área operativa, comercial y postquirúrgica la atención fue clara, precisa, oportuna y cercana. 10/10",
    avatar: "NC",
  },
  {
    id: 21,
    ...
    rating: 5,
    text_en:
      "I am very grateful to Dr. Silvia and her entire team. From the first appointment they have been by my side, always looking out for me and providing their support. It was not an easy road, but it was completely worth it. The results are truly wonderful.",
    text_es:
      "Estoy muy agradecida con la Dra. Silvia y todo su equipo. Desde la primera cita han estado a mi lado, siempre pendientes de mí y brindándome su apoyo. No fue un camino fácil, pero valió completamente la pena. Los resultados son realmente maravillosos.",
    avatar: "SD",
  },
  {
    id: 22,
    ...
    rating: 5,
    text_en:
      "The best experience thanks to the excellent work team with excellent professionals like Dr. Silvia. I was fascinated with the result of my operation thanks to that great team!",
    text_es:
      "La mejor experiencia gracias al excelente equipo de trabajo con excelentes profesionales como la doctora Silvia, quedé fascinado con el resultado de mi operación gracias a ese gran equipo!",
    avatar: "JP",
  },
  {
    id: 23,
    ...
    rating: 5,
    text_en:
      "I loved the facilities, they are beautiful and welcoming. The staff is very attentive and Dr. Silvia is a sweetheart. Everything is beautiful and perfect.",
    text_es:
      "Me encantaron las instalaciones, son hermosas y acogedoras, el personal muy atento y la Dra Silvia es un amor, todo está divino y Perfecto",
    avatar: "NP",
  },
  {
    id: 24,
    ...
    rating: 5,
    text_en:
      "My experience was excellent with super good attention from both the reception and customer service staff as well as the specialized care of Dr. Silvia Romero.",
    text_es:
      "Mi experiencia fue excelente con una atención súper buena tanto del personal de atención y recepción como la atención especializada de la Dra. Silvia Romero.",
    avatar: "CG",
  },
  {
    id: 25,
...
export const Testimonials = () => {
  ...
  const getText = (t: Testimonial) =>
    language === "en" ? t.text_en : t.text_es;
  const getTime = (t: Testimonial) =>
    language === "en" ? t.time_en : t.time_es;
  ...
  return (
    <section
      className="relative py-24 px-6 md:px-12 bg-gradient-to-b from-white to-gray-50"
      id="testimonials"
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <div className="flex items-center justify-center gap-2 mb-4">
            ...
            <span className="font-sans text-2xl font-bold text-luxury-black ml-2">
              5.0
            </span>
          </div>
