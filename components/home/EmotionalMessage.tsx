    ...
    <section className="relative py-32 px-6 bg-neutral-50 flex items-center justify-center">
      ...
      <div className="max-w-4xl text-center relative z-10">
        ...
        <p className="text-3xl md:text-4xl lg:text-5xl font-serif leading-tight text-luxury-black">
          Conmigo tú eres la protagonista de esta historia... mi propósito es poner mi experticia y arte a tu disposición... logrando una transformación de <span className="italic text-gold font-serif">cuerpo, mente y espíritu.</span>
        </p>
