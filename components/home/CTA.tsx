    ...
    <>
      ...
      <footer className="w-full bg-[#060606] border-t border-white/5">
        <div className="max-w-4xl mx-auto px-6 py-16 text-center">
          {/* Logo */}
          <NextLink href="/" className="inline-flex items-center gap-3 mb-5">
            <div className="relative h-9 w-9 flex-shrink-0">
              <Image src="/img/logoaguila.png" alt="Logo" fill className="object-contain" />
            </div>
            <div className="relative h-5 w-24 flex-shrink-0">
              <Image src="/img/image.png" alt="Dra. Silvia Romero" fill className="object-contain brightness-0 invert" />
            </div>
          </NextLink>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-10 mb-10">
            <div className="flex items-center gap-2.5 text-gray-400">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-gold/70" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            >
              <svg className="h-4 w-4 text-gold/70" viewBox="0 0 24 24" fill="currentColor">
