    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50">
      ...
      <section className="relative py-24 px-6 md:px-12 bg-luxury-black text-white">
        <div className="max-w-4xl mx-auto text-center">
          <span className="text-gold uppercase tracking-[0.3em] text-xs font-bold mb-4 block">Preguntas Frecuentes</span>
          <h1 className="text-5xl md:text-7xl font-serif mb-6">Todo lo que necesitas saber</h1>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <AccordionItem
              ...
              className="!bg-white"
            >
              Idealmente 21 días para garantizar un seguimiento adecuado y una recuperación óptima.
            </AccordionItem>
            ...
            <AccordionItem
              ...
              className="!bg-white"
            >
              La más utilizada es la anestesia general, aplicada por anestesiólogos certificados en quirófanos de nivel III.
            </AccordionItem>
            ...
            <AccordionItem
              ...
              className="!bg-white"
            >
              No, uso una técnica precisa con suturas especiales, buscando siempre la armonía en la ubicación de las cicatrices. Mi objetivo es lograr cicatrices finas y bien ubicadas. Es importante recordar que el proceso de cicatrización está mediado por factores genéticos y ambientales, por lo que es fundamental seguir el protocolo de cuidado de la cicatriz.
            </AccordionItem>
            ...
            <AccordionItem
              ...
              className="!bg-white"
            >
              Sí, es importante que tengas a tu acompañante para que te cuide y esté pendiente de ti. Si no tienes acompañante, te puedo sugerir personal calificado para este fin. Según el tipo de cirugía, es recomendable tener acompañante entre 72 horas y una semana de postoperatorio.
            </AccordionItem>
            ...
            <AccordionItem
              ...
              className="!bg-white"
            >
              Dentro del centro comercial está el hotel Novotel, el cual tiene un descuento especial para pacientes en postoperatorio y se encuentra muy cerca a todo lo necesario.
            </AccordionItem>
            ...
            <AccordionItem
              ...
              className="!bg-white"
            >
              No manejamos financiación directa, pero recibimos todos los medios de pago para tu comodidad.
            </AccordionItem>
          </Accordion>
